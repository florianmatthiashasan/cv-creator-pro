    ...
    >
      ...
      <div className="grid grid-cols-[1.4fr_0.8fr] gap-8 px-10 py-8">
        <div className="space-y-8">
          {p.summary && (
            <section>
              <h2 className="mb-3 text-sm uppercase tracking-[0.25em]" style={{ color: design.headingColor, fontFamily: design.headingFontFamily }}>Profile</h2>
          ...
          {experiences.length > 0 && (
            <section>
              <h2 className="mb-4 text-sm uppercase tracking-[0.25em]" style={{ color: design.headingColor, fontFamily: design.headingFontFamily }}>Experience</h2>
          ...
          {education.length > 0 && (
            <section>
              <h2 className="mb-4 text-sm uppercase tracking-[0.25em]" style={{ color: design.headingColor, fontFamily: design.headingFontFamily }}>Education</h2>
        ...
        <aside className="space-y-8 border-l pl-6" style={{ borderColor: design.dividerColor }}>
          ...
          {languages.length > 0 && (
            <section>
              <h2 className="mb-4 text-sm uppercase tracking-[0.25em]" style={{ color: design.headingColor, fontFamily: design.headingFontFamily }}>Languages</h2>
